...
@Mod(modid = Mod_sdasdasd.MOD_ID, name=Mod_sdasdasd.MOD_NAME, version="1.0")
public class Mod_sdasdasd {
	public static final String MOD_NAME = "sdasdasd";
    ...
    public class Mcblock_change_me extends BlockBase {
        ...
        public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hx, float hy, float hz) {
                world.newExplosion((Entity)null, x, y, z, 1001, true, true);
